...
import { checkCompliance, getApiConfig, listCompliance } from '../api/coreClient';
...
export default function CompliancePage() {
  ...
  return (
    <Card>
      ...
      <p style={{ marginTop: 0, color: colors.textSecondary }}>Главная / Админ / Compliance</p>
      <Input label="ID проекта" value={projectId} onChange={(e) => setProjectId(e.target.value)} />
      <Button type="button" onClick={onCheck} loading={loading} style={{ marginTop: spacing.sm }}>
