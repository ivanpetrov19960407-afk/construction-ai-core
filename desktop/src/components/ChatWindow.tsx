...
export default function ChatWindow() {
  ...
  const onSubmit = async (event: FormEvent) => {
    ...
    try {
      ...
      const apiUrl =
        (await settings.get<string>("api_url")) ||
    ...
    >
      ...
      >
        ...
        {isTyping && (
          ...
          >
            <span style={{ animation: "fadeIn 0.6s ease infinite alternate" }}>
              ●
            </span>
            <span
              style={{ animation: "fadeIn 0.6s ease 0.2s infinite alternate" }}
            >
              ●
            </span>
            <span
              style={{ animation: "fadeIn 0.6s ease 0.4s infinite alternate" }}
            >
              ●
            </span>
